...
/-! ## The `rfl`-checks against the concrete theorems live in `LevelInvarianceCheck.lean`

Split out (`ROADMAP.md §100`) because they need to import `LubinTateTowerStepDegree.lean`/
`LubinTateTowerStepK3Degree.lean` directly, and this file sits in the import closure of every
downstream `Level*.lean` file. -/
end LubinTate
